...
export async function commandInvoker(client, botInfo, message, group) {
    ...
    try {
        if (isGuide) {
            return sendCommandGuide(client, botInfo, message);
        }
        switch (categoryCommand) {
            case 'info':
                ...
                if (Object.keys(infoCommands).includes(commandName)) {
                    ...
                    showCommandConsole(message.isGroupMsg, "INFO", message.command, "#8ac46e", message.t, message.pushname, group === null || group === void 0 ? void 0 : group.name);
                }
                break;
            case 'utility':
                //Categoria UTILIDADE
                ...
                if (Object.keys(utilityCommands).includes(commandName)) {
                    ...
                    showCommandConsole(message.isGroupMsg, "UTILIDADE", message.command, "#de9a07", message.t, message.pushname, group === null || group === void 0 ? void 0 : group.name);
                }
                break;
            case 'sticker':
                //Categoria STICKER
                ...
                if (Object.keys(stickerCommands).includes(commandName)) {
                    ...
                    showCommandConsole(message.isGroupMsg, "STICKER", message.command, "#ae45d1", message.t, message.pushname, group === null || group === void 0 ? void 0 : group.name);
                }
                break;
            case 'download':
                //Categoria DOWNLOAD
                ...
                if (Object.keys(downloadCommands).includes(commandName)) {
                    ...
                    showCommandConsole(message.isGroupMsg, "DOWNLOAD", message.command, "#2195cf", message.t, message.pushname, group === null || group === void 0 ? void 0 : group.name);
                }
                break;
            case 'misc':
                //Categoria VARIADO
                ...
                if (Object.keys(miscCommands).includes(commandName)) {
                    ...
                    showCommandConsole(message.isGroupMsg, "VARIADO", message.command, "#22e3dd", message.t, message.pushname, group === null || group === void 0 ? void 0 : group.name);
                }
                break;
            case 'group':
                //Categoria GRUPO
                ...
                if (Object.keys(groupCommands).includes(commandName)) {
                    ...
                    showCommandConsole(message.isGroupMsg, "GRUPO", message.command, "#e0e031", message.t, message.pushname, group === null || group === void 0 ? void 0 : group.name);
                }
                break;
            case 'admin':
                //Categoria ADMIN
                ...
                if (Object.keys(adminCommands).includes(commandName)) {
                    ...
                    showCommandConsole(message.isGroupMsg, "ADMINISTRAÇÃO", message.command, "#d1d1d1", message.t, message.pushname, group === null || group === void 0 ? void 0 : group.name);
                }
                break;
            default:
                //Outros - Autosticker
                if ((message.isGroupMsg && (group === null || group === void 0 ? void 0 : group.autosticker)) || (!message.isGroupMsg && botInfo.autosticker)) {
                    await autoSticker(client, botInfo, message, group || undefined);
                    showCommandConsole(message.isGroupMsg, "STICKER", "AUTO-STICKER", "#ae45d1", message.t, message.pushname, group === null || group === void 0 ? void 0 : group.name);
                }
                break;
        }
    }
...
async function sendCommandGuide(client, botInfo, message) {
