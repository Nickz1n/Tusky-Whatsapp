...
export async function fotogrupoCommand(client, botInfo, message, group) {
    ...
    else if (message.type != 'imageMessage' && ((_a = message.quotedMessage) === null || _a === void 0 ? void 0 : _a.type) != 'imageMessage') {
        throw new Error(messageErrorCommandUsage(botInfo, message));
    }
    let imageBuffer;
    if (message.isQuoted && message.quotedMessage) {
        imageBuffer = await downloadMediaMessage((_b = message.quotedMessage) === null || _b === void 0 ? void 0 : _b.wa_message, "buffer", {});
    }
    else {
...
export async function listanegraCommand(client, botInfo, message, group) {
    ...
    for (let userId of currentBlacklist) {
        ...
        replyText += buildText(groupCommands.listanegra.msgs.reply_item, userNumberList, (userData === null || userData === void 0 ? void 0 : userData.name) || '---', waLib.removeWhatsappSuffix(userId));
    }
    await waLib.replyText(client, message.chat_id, replyText, message.wa_message, { expiration: message.expiration });
}
...
export async function banCommand(client, botInfo, message, group) {
    ...
    if (!message.mentioned.length && message.isQuoted && message.quotedMessage) {
        targetUsers.push((_a = message.quotedMessage) === null || _a === void 0 ? void 0 : _a.sender);
    }
    else if (message.mentioned.length) {
