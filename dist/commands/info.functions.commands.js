...
export async function infoCommand(client, botInfo, message, group) {
    ...
    let replyText = buildText(infoCommands.info.msgs.reply_title, (_a = botInfo.name) === null || _a === void 0 ? void 0 : _a.trim(), botStartedAt, version, botInfo.executed_cmds, adminsBotContacts);
